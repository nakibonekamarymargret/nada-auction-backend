...
const ViewProduct = () => {
    ...
    const checkWatchlistStatus = useCallback(async () => {
        ...
        try {
            ...
            const watchlist = response.data.ReturnObject;
    ...
    // --- MODIFIED FUNCTION: Prioritize `product.closed` ---
    const getAuctionStatusDisplay = () => {
        if (product && product.closed) { // If `product.closed` is true, it's always CLOSED
    ...
    if (product.closed) { // If the product itself is marked as closed
        actionButton = (
